...
public class EgitimAdapter extends RecyclerView.Adapter<EgitimAdapter.MyViewHolder>  {
    private List<Egitim> egitimList;
    private AdapterListener listener;
    private Context context;

    public EgitimAdapter(List<Egitim> egitimList, AdapterListener listener, Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final Egitim egitim = egitimList.get(position);
